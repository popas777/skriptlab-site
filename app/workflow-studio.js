(function initSkriptLabWorkflowStudio(global) {
    ...
    const MODULES = Object.freeze({
        ...
        project_memory: {
            id: 'project_memory',
            label: 'Projektimuisti',
            shortLabel: 'Projektimuisti',
        ...
        edit: {
            ...
            viewId: 'view-kirjoita-editoi',
            icon: '✎',
            inputs: 'Käsikirjoitus ja projektimuisti',
        ...
        translation: {
            ...
            label: 'Käännös',
            shortLabel: 'Käännös',
            description: 'Kääntää teoksen osissa ja käyttää projektimuistia termien sekä tyylin säilyttämiseen.',
            category: 'text',
            ...
            icon: '文',
            inputs: 'Käsikirjoitus, kielet ja projektimuisti',
            outputs: 'Kieliversio',
            inputFactor: 1,
            outputFactor: 0.95,
            baseSeconds: 160,
        ...
        product: {
            ...
            icon: '▤',
            inputs: 'Analyysi ja projektimuisti',
        ...
        covers: {
            ...
            viewId: 'view-kuvitus',
            icon: '▧',
            inputs: 'Analyysi, projektimuisti ja visuaalinen brief',
    ...
    const TEMPLATES = Object.freeze({
        translator: {
            id: 'translator',
            label: 'Kääntäjä',
            description: 'Analyysi, projektimuisti, käännös ja sen AI-tarkastus kahdessa eräaallossa.',
            icon: '文',
            modules: [
                ['analysis', 'direct'],
