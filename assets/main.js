...
const pageTranslations = {
  ...
  pricing: [
    ...
    { selector: "#writer-tools-card .price-description", fi: "Käyttöoikeus SkriptLabin kirjoitus-, analyysi-, editointi-, oikoluku-, kansi- ja taittotyökaluihin.", en: "Access to SkriptLab's writing, analysis, editing, proofreading, cover and layout tools." },
    ...
    { selector: "#writer-tools-card li:nth-child(4)", fi: "Kansi ja taitto", en: "Cover and layout" },
    { selector: "#writer-tools-card li:nth-child(5)", fi: "Tiedostoviennit", en: "File exports" },
