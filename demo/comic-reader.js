...
const pages = [
  { src: '/demo/assets/vihrea-ovi-sarjakuva-1.webp?v=7476d46c', alt: 'Vihreä ovi, sarjakuvan sivu 1: Wallace kertoo lapsuudestaan, vihreästä ovesta ja ystävällisten pantterien puutarhasta.' },
  { src: '/demo/assets/vihrea-ovi-sarjakuva-2.webp?v=7476d46c', alt: 'Vihreä ovi, sarjakuvan sivu 2: Wallace kohtaa oven elämänsä valintojen hetkellä; Redmond pohtii kertomuksen arvoitusta.' },
];
const pdf = '/demo/assets/vihrea-ovi-sarjakuva.pdf?v=7476d46c';
const pageText = ["VIHREÄ OVI\nH. G. WELLS · THE DOOR IN THE WALL · SARJAKUVASOVITUS\nEräänä iltana ystäväni Lionel Wallace kertoi minulle\nlapsuutensa salaisuuden. Vieläkään en tiedä, mitä uskoa.\n”Olin viisivuotias ja kuljin yksin\nkaupungilla, kun löysin vihreän oven.”\n”Puutarhassa en pelännyt mitään.\nTuntui kuin olisin tullut kotiin.”\n”Siellä minut otettiin heti mukaan\nleikkiin. En ollut enää yksin.”\n”Kirjan sivuilla\nnäin koko elämäni.\nKaikki eli ja liikkui.”\nMitä sitten\ntapahtuu?\n”Käänsin sivua ja olin taas kadulla. Kun\nkerroin puutarhasta kotona, isä antoi selkään.”\n”Vuosia myöhemmin löysin\noven koulumatkalla. Juoksin\nohi, etten myöhästyisi.”\n”Vein muut pojat katsomaan, mutta ovea\nei löytynyt. Yksinkin etsin turhaan.”\n", "”Seitsemäntoistavuotiaana näin oven taas,\nmatkalla Oxfordin stipendikokeeseen.”\n”Jatkoin matkaa ja sain stipendin.\nSilloin uskoin valinneeni oikein.”\n”Viime aikoina olen nähnyt oven kolmesti.\nEnsin kiirehdin parlamenttiin äänestämään.”\n”Toisella kerralla olin matkalla\nisän luo. Hän teki kuolemaa.”\n”Kolmannella kerralla halusin ministeriksi.\nEn malttanut jättää keskustelua kesken.”\nKunpa olisin mennyt sisään.\nNyt en enää löydä ovea.\n”Öisin kuljen taas yksin\nkaupungilla. Etsin yhä sitä ovea.”\nMyöhemmin luin lehdestä,\nettä Wallace oli kuollut.\nHänet oli löydetty\ntyömaan kaivannosta.\nTyömaa-aidan ovi oli jäänyt salpaamatta,\nja Wallace oli kulkenut siitä sisään.\nMe näemme vain työmaa-aidan ja kuopan.\nMutta mitä Wallace näki?\n"];
